...
},{"@babel/runtime-corejs2/core-js/promise":"../node_modules/@babel/runtime-corejs2/core-js/promise.js"}],"../src/components/Header.js":[function(require,module,exports) {
"use strict";
...
var Header = function Header() {
  var template = "\n        <header>\n            <h1>Simple Workflow</h1>\n            <p>A vanilla JS built workflow platform.</p>\n        </header>\n    ";
  return template;
};
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../src/components/User.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(user);
            template = "\n    <div class='card'>\n        <img src='".concat(user.picture.large, "' />\n        <div class='card-body'>\n        <h1>").concat(user.name.title, ". ").concat(user.name.first, " ").concat(user.name.last, "</h1>\n        <ul>\n        <li>Tel: ").concat(user.phone, "</li>\n        <li>Email: ").concat(user.email, "</li>\n        <li>Live in ").concat(user.location.city, " ").concat(user.location.state, ", ").concat(user.location.country, "</li>\n        <li>Username: ").concat(user.login.username, "</li>\n        <li>UUID: ").concat(user.login.uuid, "</li>\n        <li>D.O.B: ").concat(user.dob.date, "</li>\n        </ul>\n        </div>\n    </div>\n    ");
...
var _default = User;
exports.default = _default;
},{"@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","axios":"../node_modules/axios/index.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            document.getElementById('user').innerHTML = _context.sent;
...
app();
},{"@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","./components/Header":"../src/components/Header.js","./components/User":"../src/components/User.js","./scss/app.scss":"../src/scss/app.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11211" + '/');
